    ...
    return (
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="publishedDate">
                ...
                <Form.Control type="date" name="publishedDate" value={post.publishedDate} onChange={handleChange} required />
            </Form.Group>
            </div>
            <Form.Group className='mt-3' controlId="shortDescription">
                <Form.Label>Short description</Form.Label>
                <Form.Control as="textarea" name="shortDescription" value={post.shortDescription} onChange={handleChange} required />
            </Form.Group>
            <Form.Group className='mt-3' controlId="content">
                <Form.Label>Main content</Form.Label>
                <Form.Control as="textarea" name="content" value={post.content} onChange={handleChange} required rows={4} />
            </Form.Group>
